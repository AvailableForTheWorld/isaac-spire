...
const en = {
  translation: {
    ...
    home: {
      ...
      ruleBreak: 'BREAK', ruleBreakBody: 'Items rewrite the rules: active items become rechargeable skill cards; passive items reshape Isaac for the full run.',
    ...
    combat: {
      ...
      hand: 'YOUR HAND · {{count}}/{{max}}', target: 'Targeting {{enemy}}', chooseTarget: 'Choose a target',
      ...
      activeRetained: 'ACTIVE · RETAINED', recharging: 'RECHARGING · {{rounds}}', oneOff: 'ONE-OFF', passiveItems: 'PASSIVE ITEMS', noPassiveItems: 'NO PASSIVES',
    ...
    cardTypes: { attack: 'attack', skill: 'skill', recovery: 'recovery', shield: 'shield', hex: 'hex', tarot: 'tarot', curse: 'curse' },
...
const zhCN = {
  translation: {
    ...
    home: {
      ...
      tagline1: '六层地牢。', tagline2: '五点活力。', tagline3: '一路向下。',
      ruleRoute: '路线', ruleRouteBody: '在三条交织的分支间选择。每条路线都有宝箱房、商店和需要炸弹开启的隐藏房。',
      ruleFight: '战斗', ruleFightBody: '抽取七张牌并消耗五点活力。观察敌人的六类意图，回合结束时最多保留五张牌。',
      ruleBreak: '破局', ruleBreakBody: '道具会改写规则：主动道具化为可充能技能牌，被动道具则会在整局中重塑以撒。',
    ...
    combat: {
      room: '{{room}}房', round: '第 {{round}} 回合', vitality: '{{value}} 活力', vitalityHint: '每个玩家回合都会恢复活力', animatedRoom: '动态战斗房间',
      hp: '生命', armor: '护甲', shield: '护盾', cursed: '诅咒 {{turns}} 回合', weakened: '诅咒 · 攻击降低 40% · 剩余 {{turns}} 回合', staggered: '硬直 · 本次行动丢失', hand: '手牌 · {{count}}/{{max}}', target: '目标：{{enemy}}', chooseTarget: '选择一个目标',
      discardPrompt: '可任意弃牌，随后最多保留 {{count}} 张', draw: '抽牌堆 {{count}}', discard: '弃牌堆 {{count}}', deck: '牌组 {{count}}', discardAll: '全部弃掉',
      faceEnemy: '进入敌方回合', endTurn: '结束玩家回合', preparing: '正在准备房间…', activeRetained: '主动道具 · 保留', recharging: '充能中 · {{rounds}}', oneOff: '一次性', passiveItems: '被动道具', noPassiveItems: '暂无被动道具',
    ...
    cardTypes: { attack: '攻击', skill: '技能', recovery: '恢复', shield: '护盾', hex: '咒术', tarot: '塔罗牌', curse: '诅咒' },
    ...
    upgrades: {
      ...
      skill: { name: '电池组', description: '主动道具充能时间减少一回合。' }, vitality: { name: '肾上腺素', description: '活力上限 +1。' },
    },
    stats: {
      character: '以撒', title: '属性', damage: '伤害', armor: '护甲', startShield: '初始护盾', fireRate: '射速', vitality: '活力', draw: '抽牌数', critical: '暴击率',
    ...
    errors: {
      notInCombat: '当前不在战斗中', cardNotInHand: '这张牌不在手中', unknownCard: '未知卡牌', curseUnplayable: '负面诅咒牌无法打出', vitality: '活力不足', recharging: '主动道具正在充能',
      coins: '硬币不足', bomb: '需要一枚炸弹才能开启这个房间', containers: '恶魔交易需要一个可供支付的红心上限', sacrifice: '红心生命不足，无法在献祭后存活', unavailable: '当前无法执行该操作',
    },
    logs: {
      enter: '第 1 回合 — {{enemies}} 进入了房间。', attack: '{{card}}造成了 {{damage}} 点伤害{{mode}}{{echo}}。', echo: '，并追加 {{count}} 次回响攻击', reroll: '六面骰重置了 {{count}} 张牌。',
      ...
      prepare: '{{enemy}}正在准备双倍伤害攻击！', hesitate: '{{enemy}}犹豫不决。', nextRound: '第 {{round}} 回合 — 活力恢复至 {{vitality}}。',
    },
    floors: {
    ...
    cards: {
      'isaacs-tears': { name: '以撒的眼泪', description: '造成 100% 眼泪伤害。射速可以触发回响攻击。' },
      ...
      'dead-weight': { name: '沉重诅咒', description: '无法打出。由敌人的诅咒加入牌组。' }, 'skill-d6': { name: '六面骰', description: '重置手中所有非技能牌。3 回合后充能完毕。' },
    ...
    items: {
      d6: { name: '六面骰', description: '重置其余手牌。以撒初始携带。' }, 'yum-heart': { name: '美味的心', description: '恢复一整颗红心。' },
