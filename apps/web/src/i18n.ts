...
const en = {
  translation: {
    ...
    combat: {
      ...
      vitalityLabel: 'STAMINA', deploymentTitle: 'Choose a starting position', deploymentKicker: 'FREE DEPLOYMENT', deploymentPrompt: 'Place Isaac before combat', deploymentHint: 'Choose any blue tile in the left half of the room. Reposition freely, then confirm to begin the round.', confirmDeployment: 'Start combat', cardsLockedDuringDeployment: 'Choose a starting tile before playing cards', deployHere: 'Deploy at ({{x}}, {{y}}) · free', deploymentLegend: 'Starting-position zone',
      ...
      targetGuideTitle: 'AIM AT AN ENEMY PANEL', targetGuideHint: 'Move the attack arrow to a glowing target, then click to attack. Press Esc to cancel.', targetSeek: 'Aim at a glowing enemy', targetAvailable: 'AVAILABLE TARGET', targetReady: 'CLICK TO ATTACK',
      ...
      playerTurn: 'PLAYER TURN', enemyTurn: 'ENEMY TURN', discardPhase: 'DISCARD PHASE', armorBlocked: 'ARMOR', shieldBlocked: 'SHIELD', resolving: 'RESOLVING ACTIONS', bossDoubleAction: '2 ACTIONS',
...
const zhCN = {
  translation: {
    ...
    combat: {
      ...
      vitalityLabel: '体力', deploymentTitle: '选择起始位置', deploymentKicker: '自由部署阶段', deploymentPrompt: '战斗前放置以撒', deploymentHint: '点击房间左半区的蓝色格子，可以不限次数调整；确认后正式开始本回合。', confirmDeployment: '开始战斗', cardsLockedDuringDeployment: '请先选择起始位置，再使用卡牌', deployHere: '部署到 ({{x}}, {{y}}) · 不消耗体力', deploymentLegend: '可选择的起始区域',
      ...
      targetGuideTitle: '将攻击箭头指向敌人面板', targetGuideHint: '移动鼠标至发光的敌人面板，箭头会自动吸附；点击发动攻击，Esc 取消。', targetSeek: '瞄准一个发光的敌人', targetAvailable: '可选目标', targetReady: '点击攻击',
      discardPrompt: '可任意弃牌，随后最多保留 {{count}} 张', draw: '抽牌堆 {{count}}', discard: '弃牌堆 {{count}}', deck: '牌组 {{count}}', discardAll: '全部弃掉',
      faceEnemy: '进入敌方回合', endTurn: '结束玩家回合', preparing: '正在准备房间…', activeRetained: '主动道具 · 保留', recharging: '充能中 · {{rounds}}', oneOff: '一次性', passiveItems: '持有道具', noPassiveItems: '暂无被动道具', chargeProgress: '充能 {{current}} / {{max}}',
      playerTurn: '玩家回合', enemyTurn: '敌方回合', discardPhase: '弃牌阶段', armorBlocked: '护甲抵挡', shieldBlocked: '护盾抵挡', resolving: '正在结算行动', bossDoubleAction: '双指令',
