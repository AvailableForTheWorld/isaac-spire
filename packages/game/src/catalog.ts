...
export const CARDS: Record<string, CardDefinition> = {
  ...
  'wooden-cross': {
    ...
    cost: 1,
    value: 5,
    description: 'Gain 5 shield. Shield persists for the room.',
  ...
  'half-heart': {
    ...
    cost: 1,
    value: 10,
    description: 'Recover 10 red-heart HP.',
    target: CardTarget.Self,
    icon: '♥',
    quality: RewardQuality.Common,
...
const CURATED_ITEMS: Record<string, ItemDefinition> = {
  ...
  breakfast: {
    ...
    name: 'Breakfast',
    kind: ItemKind.Passive,
    pool: [RewardPool.Boss, RewardPool.RoomClear, RewardPool.Bedroom],
    quality: RewardQuality.Common,
    icon: '⌑',
    description: 'Adds a reusable card that recovers 15 red-heart HP.',
